...
func (this *SingleChoiceRaceToMax) Start(from VoteMachineType, seed interface{}) {
...
func (this *SingleChoiceRaceToMax) GetTallyResult() (VoteMachineType, int, interface{}) {
	return VM_SingleChoiceRaceToMax, this.result, this.voted
}
