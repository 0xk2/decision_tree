...
import (
	...
	"github.com/0xk2/decision_tree/decision_tree/votemachine"
	"github.com/0xk2/decision_tree/ppds/tree"
)
...
type CheckPoint struct {
	...
	IsOuput         bool
	VoteMachineType votemachine.VoteMachineType
	AllData         interface{}
...
func (this *CheckPoint) Start(from votemachine.VoteMachineType, input interface{}) {
	if this.VoteMachine != nil {
		this.VoteMachine.Start(from, input)
	}
}

func CreateEmptyCheckPoint(name string, isOutput bool, voteMachineType votemachine.VoteMachineType, data interface{}) *CheckPoint {
...
func (this *CheckPoint) FinishAttachChildren() bool {
	...
	if machine == nil {
		log.Println("cannot build vote machine for", this.Name)
		return false
	}
...
func (this *CheckPoint) GetTallyResult() (votemachine.VoteMachineType, int, interface{}) {
